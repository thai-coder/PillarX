...
interface SteelJoistPropertiesProps {
...
const SteelJoistProperties: React.FC<SteelJoistPropertiesProps> = ({ onUpdate }) => {
  const [data, setData] = useState({ length: 24, depth: 16 });
...
export default SteelJoistProperties;